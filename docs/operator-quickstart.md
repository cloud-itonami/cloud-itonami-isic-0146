# Operator Quickstart — Poultry-Farm Operations Coordination

Shortest path from clone to a verified local dry-run for **ISIC 0146** (`cloud-itonami-isic-0146`).
...
```bash
git clone https://github.com/cloud-itonami/cloud-itonami-isic-0146.git
cd cloud-itonami-isic-0146
```
...
- Blueprint governor key: `poultry-farm-operations-governor`
- Likely source path: `poultryops.governor.cljc`
